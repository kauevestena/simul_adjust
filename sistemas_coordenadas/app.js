...
import * as esfericasModule from './models/esfericas.js';
import * as astronomicasModule from './models/astronomicas.js';
import * as ecefModule from './models/ecef.js';
import * as enuModule from './models/enu.js';
import * as planoLocalModule from './models/plano_local.js';

// ============================================
// Model Registry
// ============================================
const models = [
    { id: 'geodesicas',   module: geodesicasModule },
    { id: 'esfericas',    module: esfericasModule },
    { id: 'astronomicas', module: astronomicasModule },
    { id: 'ecef',         module: ecefModule },
    { id: 'enu',          module: enuModule },
    { id: 'plano_local',  module: planoLocalModule },
];
...
function rerenderMath() {
    if (typeof renderMathInElement === 'function') {
        renderMathInElement(document.getElementById('info-content'), {
            delimiters: [
